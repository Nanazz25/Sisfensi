...
@section('content')
    ...
    <div class="card">
        ...
        <div class="body">
            ...
            <form method="GET" action="{{ route('users.guru') }}" id="filterForm"
                ...
                <div class="col-6 col-md-auto">
                    <a href="{{ route('users.guru') }}" class="btn btn-sm btn-outline-danger btn-block rounded-pill shadow-xs d-flex align-items-center justify-content-center" style="height: 38px;">

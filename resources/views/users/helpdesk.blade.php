@extends('layouts.app')
@section('title', 'User Helpdesk (Operator)')

@section('content')

    <div class="card">
        <div class="header d-flex justify-content-between align-items-center">
            <h2>User Helpdesk (Operator)</h2>
        ...
        <div class="body">
            ...
            <form method="GET" action="{{ route('users.helpdesk') }}" id="filterForm"
                ...
                <div class="col-6 col-md-auto">
                    <a href="{{ route('users.helpdesk') }}" class="btn btn-sm btn-outline-danger btn-block rounded-pill shadow-xs d-flex align-items-center justify-content-center" style="height: 38px;">
